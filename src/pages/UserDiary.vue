...
export default {
  data() {
    return {
      ...
      //   },
      // },
      foodData: [ // will be indexed, like the carousel dateList
        {
          "Tue, 2. May 23": {
            // TODO: store data for food element like this (also for addFood method):
            breakfast: [
  ...
  computed: {
    ...
    breakfastItems() {
      if (this.dateList && this.activeSlide !== null) {
        ...
        // console.log(foodData["Tue, 2. May 23"].breakfast);
        // console.log("breakfast:");
        // const date = this.dateList[this.activeSlide];
        // console.log(date);
        // // console.log(foodData[`${this.dateList[this.activeSlide]}`].breakfast);
  ...
  methods: {
    ...
    getFoodData() {
      ...
      // }
      if (this.dateList != null && this.activeSlide !== null) {
        // this is printing "undefined" and then afterwards the correct value
        const date = this.dateList.at(this.activeSlide);
        console.log(date);
        // console.log(this.foodData[this.activeSlide][this.dateList.at(this.activeSlide)]);
