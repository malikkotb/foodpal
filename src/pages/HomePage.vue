  ...
  <div>
    <main>
      <div class="container-fluid px-4">
        ...
        <!-- <div class="row">
          <div class="col-xl-6">
            <div class="card mb-4">
              <div class="card-header">
                <svg
                  class="svg-inline--fa fa-chart-area me-1"
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
              ...
              <div class="card-body">
                ...
                <canvas
                  ...
                  width="438"
                  height="175"
                  style="display: block; width: 438px; height: 175px"
          ...
          <div class="col-xl-6">
            <div class="card mb-4">
              <div class="card-header">
                <svg
                  class="svg-inline--fa fa-chart-bar me-1"
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                  data-icon="chart-bar"
        ...
        <!-- First Row Dashobard Data Start -->
          ...
          <div class="col-xl-4 col-md-6">
            <div class="card mb-4">
              <div class="card-header">
                ...
                Calorie Ring Remaining = Goal - Food
                Chartjs Dougnhut Chart
              </div>
              <div class="card-body">
                <div class="chartjs-size-monitor">
                  <div class="chartjs-size-monitor-expand">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="card mb-4">
              <div class="card-header">
                ...
                Heart Healthy Bar Chart Sideways
                Amounts today: Fat, Sodium, Cholesterol
              </div>
              <div class="card-body">
                <div class="chartjs-size-monitor">
                  <div class="chartjs-size-monitor-expand">
